...
def main(args=None):
    ...
    #
    # build CUDA extension in mmdet ROOT
    #
    sys.argv = ["setup.py", "build", "install"]
    WORKING_DIR = os.getcwd()
    FILE_DIR = os.path.dirname(os.path.abspath(__file__))
    print(os.path.join(FILE_DIR, "./models/dab_deformable_detr/ops"))
    os.chdir(os.path.join(FILE_DIR, "./models/dab_deformable_detr/ops"))
    print(os.getcwd())
    setup(
    ...
    args.training_script = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "main.py"
    )
    args_list = load_config(args.config)
    args.training_script_args = args_list
