...
from models import build_dab_deformable_detr, build_DABDETR
...
def get_args_parser():
    ...
    parser.add_argument(
        "--lr_backbone", default=1e-5, type=float, help="learning rate for backbone"
    )
    ...
    # * Loss coefficients
    parser.add_argument(
        "--cls_loss_coef", default=1, type=float, help="loss coefficient for cls"
    )
    parser.add_argument(
        "--mask_loss_coef", default=1, type=float, help="loss coefficient for mask"
    )
    parser.add_argument(
        "--dice_loss_coef", default=1, type=float, help="loss coefficient for dice"
    )
    parser.add_argument(
        "--bbox_loss_coef",
        default=5,
    ...
    parser.add_argument(
        "--focal_alpha", type=float, default=0.25, help="alpha for focal loss"
    )
    ...
    parser.add_argument(
        "--train_ann_file", type=str, default="annotations/instances_train2017.json"
    )
    parser.add_argument("--train_img_prefix", type=str, default="./train2017")
    parser.add_argument(
        "--val_ann_file", type=str, default="annotations/instances_val2017.json"
    )
    parser.add_argument("--val_img_prefix", type=str, default="./val2017")
    parser.add_argument(
        "--test_ann_file", type=str, default="annotations/image_info_test-dev2017.json"
    )
    parser.add_argument("--test_img_prefix", type=str, default="./test2017")
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % args.lr_drop == 0:
                checkpoint_paths.append(
                    output_dir / f"checkpoint{epoch:04}_beforedrop.pth"
                )
