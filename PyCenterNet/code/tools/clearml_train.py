#
# original: https://github.com/pytorch/pytorch/blob/master/torch/distributed/launch.py
#
r"""
...
def main():
    ...
    #
    os.environ['PYTHONPATH'] = os.path.join(FILE_DIR, '..')
    
    if args.dataset_id and args.dataset_path:
        Dataset.get(dataset_id=args.dataset_id).get_mutable_local_copy(args.dataset_path)

    args.training_script = os.path.join(FILE_DIR, 'train.py')
    args.training_script_args = args.remainder + ['--launcher', 'pytorch', args.config]
