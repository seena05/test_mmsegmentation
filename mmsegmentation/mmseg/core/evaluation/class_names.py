...
def esophageal_classes():
    return ['background', 'cancer']

def esophageal_3class_classes():
    return ['background', 'cancer', 'noncancer']
...
def esophageal_palette():
    return [[0, 0, 0], [0, 100, 255]]

def esophageal_3class_palette():
    return [[0, 0, 0], [0, 100, 255], [0, 255, 100]]
...
dataset_aliases = {
    ...
    'esophageal_3class': ['esophageal_3class']
}
