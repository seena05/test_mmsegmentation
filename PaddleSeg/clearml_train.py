#
# original: https://github.com/PaddlePaddle/Paddle/blob/release/2.2/python/paddle/distributed/fleet/launch.py
#
...
def launch():
    ...
    args.training_script_args = ['--config', args.config] + args.remainder
